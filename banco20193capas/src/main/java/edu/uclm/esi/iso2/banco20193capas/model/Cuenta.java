...
public class Cuenta {
	...
	/**
	 * Realiza una transferencia desde esta cuenta a la cuenta que se
	 * pasa como primer parámetro. Se cobra una comisión del 1%,
	 ...
	 *             Si el importe es <=0
	 * @throws SaldoInsuficienteException
	 *             Si la cuenta no tiene saldo suficiente para afrontar el
