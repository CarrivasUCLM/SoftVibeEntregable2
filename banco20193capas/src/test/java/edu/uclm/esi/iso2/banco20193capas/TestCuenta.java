...
public class TestCuenta extends TestCase {
    ...
    public void testMovimientoTCAtributos() {
        ...
        try {
            ...
            cuentaPepe.insert();
            TarjetaCredito tc = cuentaPepe.emitirTarjetaCredito("12345X", 1000);
            TarjetaCredito tc1 = cuentaPepe.emitirTarjetaCredito("12345X",
                    2000);
            MovimientoTarjetaCredito mtc = new MovimientoTarjetaCredito(tc, 200,
                    "Alquiler");
            mtc.setId((long) 2);
            mtc.setTarjeta(tc1);
            mtc.setImporte(300);
    ...
    public void testCuentaAtributos() {
        ...
        try {
            ...
            cuentaAna.addTitular(ana);
            cuentaAna.insert();
            MovimientoCuenta mc = new MovimientoCuenta(cuentaPepe, 200,
                    "Alquiler");
            mc.setId((long) 2);
